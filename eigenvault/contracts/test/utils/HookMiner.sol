...
library HookMiner {
    ...
    function hasFlag(address hookAddress, uint160 flag) internal pure returns (bool hasFlag) {
    ...
    function generateSalt(uint256 seed) internal pure returns (bytes32 salt) {
