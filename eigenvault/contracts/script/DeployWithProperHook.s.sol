...
import "../test/helpers/HookDeployer.sol";

/// @title DeployWithProperHook
/// @notice Deployment script for EigenVault system on Anvil with proper hook deployment
contract DeployWithProperHook is Script {
    ...
    function run() external {
        ...
        console.log("Deploying EigenVault system with proper hook on Anvil...");
        ...
        // 5. Deploy HookDeployer and use it to deploy the hook
        ...
        console.log("Deploying EigenVaultHook with proper address...");
        (EigenVaultHook hook, bytes32 salt) = hookDeployer.deployHook(
        ...
        console.log("Hook deployment salt:", vm.toString(salt));
        ...
        string memory deploymentInfo = string.concat(
            ...
            "HOOK_DEPLOYER=", vm.toString(address(hookDeployer)), "\n",
